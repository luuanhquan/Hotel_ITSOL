...
export class RoomComponent implements OnInit {
    ...
    updateRoomType() {
        this.roomService.updateRoomType(this.rtTemp).subscribe(() => {
            this.getRoomType();
            this.getRoomList()
        })
    ...
    createRoom() {
        this.roomService.createRoom(this.roomCreate).subscribe(() => {
            this.getRoomList()
        })
        this.modalService.dismissAll()
    }
    ...
    saveRoom() {
        this.roomService.updateRoom(this.roomSelected).subscribe(() => {
            this.getRoomList()
        })
        this.modalService.dismissAll()
    }
